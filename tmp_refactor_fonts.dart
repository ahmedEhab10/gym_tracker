...
void main() {
  ...
  final importStatement = "import 'package:flutter_screenutil/flutter_screenutil.dart';";
      ...
      if (matched && newContent != content) {
        if (!newContent.contains(importStatement)) {
          ...
          if (matches.isNotEmpty) {
            ...
            newContent = newContent.substring(0, lastMatch.end) + 
                         '\n' + importStatement + 
                         newContent.substring(lastMatch.end);
          } else {
